...
from ultralytics.engine.ct_tracker import CtTracker
...
class BaseTrainer:
    ...
    def _do_train(self):
        ...
        tsb_ct_log_dir = f'{self.args.save_dir}/ct_tsb'
        os.makedirs(tsb_ct_log_dir, exist_ok=True)
        self.ct_loss_trackers = CtTracker(tsb_ct_log_dir)
        ...
        while True:
            ...
            # Contrastive 
            self.ct_loss_trackers.add_scalar(epoch)
            epoch += 1
